...
const Counter = () => {
  ...
  useEffect(() => {
    ...
    return (
        ...
        {/* counter card */}
        <div  ref={bannerRef}  className='grid grid-cols-2 lg:grid-cols-4 gap-6 justify-center my-16  '>
             <div className='p-6 border-1 border-none  bg-white rounded-xl  md:w-60 h-64 space-y-5 shadow-2xl mx-auto'>
